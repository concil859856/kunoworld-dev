...
| `ltx-2.5-4k` | `ltx-2.5-dfr/bf16/1` (reads `diffusion_decoder`) | `84bad8c6f981c2c05f662947bf749798712597b568f8f99eca2f7b8a1a8ec554` (subnet `2448860`, image `ltx-0.1.0-25d8d065d34a`) |
...
- **Where:** computed on the 4K check box with the image built at subnet `2448860`.
